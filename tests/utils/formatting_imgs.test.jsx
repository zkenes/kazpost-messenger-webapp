...
describe('Markdown.Imgs', function() {
    it('Inline mage', function(done) {
        assert.equal(
            ...
            '<p><img src="/images/icon.png" alt="Tink" class="markdown-inline-img"></p>'
        );
    ...
    it('Image with hover text', function(done) {
        assert.equal(
            ...
            '<p><img src="/images/icon.png" alt="Tink" title="Mattermost Icon" class="markdown-inline-img"></p>'
        );
    ...
    it('Image with link', function(done) {
        assert.equal(
            ...
            '<p><a class="theme markdown__link" href="https://github.com/mattermost/platform" rel="noreferrer" target="_blank"><img src="../../images/icon-76x76.png" alt="Tink" class="markdown-inline-img"></a></p>'
        );
    ...
    it('Image with width and height', function(done) {
        assert.equal(
            ...
            '<p><img src="../../images/icon-76x76.png" alt="Tink" title="Mattermost Icon" width="50" height="76" class="markdown-inline-img"></p>'
        );
    ...
    it('Image with width', function(done) {
        assert.equal(
            ...
            '<p><img src="../../images/icon-76x76.png" alt="Tink" title="Mattermost Icon" width="50" class="markdown-inline-img"></p>'
        );
