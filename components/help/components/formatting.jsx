...
export default function HelpFormatting() {
    ...
    message.push('```\n' + localizeMessage('help.formatting.codeBlock', 'code block') + '\n```');
    message.push(localizeMessage('help.formatting.syntax', '### Syntax Highlighting\n\nTo add syntax highlighting, type the language to be highlighted after the ``` at the beginning of the code block. Messenger also offers four different code themes (GitHub, Solarized Dark, Solarized Light, Monokai) that can be changed in **Account Settings** > **Display** > **Theme** > **Custom Theme** > **Center Channel Styles**'));
    ...
    message.push('![go syntax-highlighting](https://docs.tink.com/_images/syntax-highlighting-github.PNG)');
    message.push(localizeMessage('help.formatting.solirizedDarkTheme', '**Solarized Dark Theme**'));
    message.push('![go syntax-highlighting](https://docs.tink.com/_images/syntax-highlighting-sol-dark.PNG)');
    message.push(localizeMessage('help.formatting.solirizedLightTheme', '**Solarized Light Theme**'));
    message.push('![go syntax-highlighting](https://docs.tink.com/_images/syntax-highlighting-sol-light.PNG)');
    message.push(localizeMessage('help.formatting.monokaiTheme', '**Monokai Theme**'));
    message.push('![go syntax-highlighting](https://docs.tink.com/_images/syntax-highlighting-monokai.PNG)');
    ...
    message.push('`' + localizeMessage('help.formatting.linkEx', '[Check out Messenger!](https://about.Messenger.com/)') + '`');
    message.push(localizeMessage('help.formatting.renders', 'Renders as:') + ' ' + localizeMessage('help.formatting.linkEx', '[Check out Messenger!](https://about.Messenger.com/)'));
    message.push(localizeMessage('help.formatting.images', '## In-line Images\n\nCreate in-line images using an `!` followed by the alt text in square brackets and the link in normal brackets. Add hover text by placing it in quotes after the link.'));
    message.push('```\n' + localizeMessage('help.formatting.imagesExample', '![alt text](link "hover text")\n\nand\n\n[![Build Status](https://travis-ci.org/Messenger/platform.svg?branch=master)](https://travis-ci.org/Messenger/platform) [![Github](https://assets-cdn.github.com/favicon.ico)](https://github.com/Messenger/platform)') + '\n```');
    message.push(localizeMessage('help.formatting.renders', 'Renders as:'));
    message.push(localizeMessage('help.formatting.imagesExample', '![alt text](link "hover text")\n\nand\n\n[![Build Status](https://travis-ci.org/Messenger/platform.svg?branch=master)](https://travis-ci.org/Messenger/platform) [![Github](https://assets-cdn.github.com/favicon.ico)](https://github.com/Messenger/platform)'));
    message.push(localizeMessage('help.formatting.emojis', '## Emojis\n\nOpen the emoji autocomplete by typing `:`. A full list of emojis can be found [here](http://www.emoji-cheat-sheet.com/). It is also possible to create your own [Custom Emoji](http://docs.Messenger.com/help/settings/custom-emoji.html) if the emoji you want to use doesn\'t exist.'));
