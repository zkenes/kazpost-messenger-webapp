        ...
        return (
            <SettingsGroup>
                ...
                <DropdownSetting
                    ...
                    values={[
                        {value: RESTRICT_DIRECT_MESSAGE_ANY, text: Utils.localizeMessage('admin.team.restrict_direct_message_any', 'Any user on the Messenger server')},
