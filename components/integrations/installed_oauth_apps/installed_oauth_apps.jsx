            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Create {oauthApplications} to securely integrate bots and third-party apps with Messenger. Visit the {appDirectory} to find available self-hosted apps.'
                        values={{
                            oauthApplications: (
                                <a
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    href='https://docs.Messenger.com/developer/oauth-2-0-applications.html'
                                >
                                    <FormattedMessage
