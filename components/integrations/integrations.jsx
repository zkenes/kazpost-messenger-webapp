                    ...
                    <IntegrationOption
                        ...
                        description={
                            <FormattedMessage
                                ...
                                defaultMessage='Auth 2.0 allows external applications to make authorized requests to the Messenger API.'
                            />
                        }
            ...
            <div className='backstage-content row'>
                ...
                <div className='backstage-list__help'>
                    <FormattedMessage
                        ...
                        defaultMessage='Visit the {appDirectory} to find self-hosted, third-party apps and integrations for Messenger.'
                        values={{
                            appDirectory: (
                                <a
                                    target='_blank'
